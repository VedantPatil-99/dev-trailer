  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden pt-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-40 right-1/4 h-80 w-80 rounded-full bg-gradient-to-l from-cyan-500/20 to-transparent blur-3xl" />
        <div className="absolute bottom-0 left-1/2 h-full w-full -translate-x-1/2 bg-gradient-to-t from-emerald-500/5 via-transparent to-transparent" />
      </div>
      ...
      >
        ...
        {/* Main heading */}
        <motion.h1 variants={itemVariants} className="text-balance max-w-5xl">
          <span className="block text-6xl font-black tracking-tight sm:text-7xl lg:text-8xl">
            Your Code{" "}
            <span className="relative inline-block">
              <span className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-cyan-500 blur-xl opacity-50" />
        ...
        >
          <button className="group relative inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-500 px-8 py-4 font-semibold text-black transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/40">
            <span className="relative z-10 flex items-center gap-2">
              <Play size={20} weight="fill" />
              Get Started Free
            </span>
            <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-emerald-400 to-cyan-400 opacity-0 blur transition-opacity duration-300 group-hover:opacity-100" />
          </button>
        ...
        <motion.div
          ...
          className="absolute bottom-20 left-10 h-20 w-20 rounded-lg border border-emerald-500/20 bg-emerald-500/5 backdrop-blur-sm opacity-30"
        />
        <motion.div
          animate={{ y: [0, 20, 0] }}
          transition={{ duration: 5, repeat: Infinity }}
          className="absolute bottom-40 right-10 h-16 w-16 rounded-full border border-cyan-500/20 bg-cyan-500/5 backdrop-blur-sm opacity-30"
        />
      </motion.div>
    </section>
  );
